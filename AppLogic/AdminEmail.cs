...
namespace AppLogic
{
    ...
    {
        public async Task<string> SendEmail(string emailAddress) // DTO Email 
        {
            ...
            EmailContent emailContent = new EmailContent("Queremos agradecerle por reservar su cita"); // Subject
            emailContent.PlainText = "Hemos recibido su solicitud de cita, y nos pondremos en contacto con usted";

            List<EmailAddress> emailAddresses = new List<EmailAddress> { new EmailAddress(emailAddress, "Suscriptor de Cita") };
